/* Activity data is stored in xml/activities.xml.
   loadActivities() fetches and parses that XML file into the same
   object shape the rest of the app expects, so activities.js and
   mood-checker.js do not need to change. */
